...
if (isset($_GET["submit"])) {
    ...
    if ($submit == "delete") {
        ...
        try {
            $stmt = $conn->prepare($sqldelete); #execute
            $stmt->execute();
...
<body>
    ...
    <div class="w3-bar w3-blue-gray">
        ...
        <a href="newinventory.php" class="w3-bar-item w3-button w3-left">New Inventory</a>
    ...
    <div class="w3-card w3-container w3-padding w3-margin w3-round">
        ...
        if ($number_of_result > 0) {
            ...
            foreach ($rows as $items) {
                ...
                <td>$condition</td>
                <td>$created_at</td>
                <td><a href='home.php?submit=delete&id=$id' onclick = 'return confirm(\"Are you sure you want to delete this item? \");'><button>&nbspDelete</button></a>
                <a href='edit.php?id=$id'><button>Update</button></a></td>
                </tr>";
            }
            echo "</table>";
        }
    ...
    <div class="w3-container w3-row w3-center">
        <?php
            for ($page = 1; $page <= $number_of_page; $page++) {
                echo '<a href = "home.php?pageno=' . $page . '" style=
